def create_scorer_tree():
    tree = {
        ...
        "atBallScore": {"condition": lambda mgr, state: mgr.getDistance("b") < 0.8, "trueCond": "startDribble", "falseCond": "goToBallScore"},
        "startDribble": {"exec": lambda mgr, state: state.__setitem__("status", "dribble"), "next": "checkDribble"},
        "checkDribble": {"condition": lambda mgr, state: state["status"] == "dribble", "trueCond": "closeEnoughToKick", "falseCond": "waitGoalScorer"},
