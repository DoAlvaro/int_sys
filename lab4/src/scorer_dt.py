def create_scorer_tree():
    tree = {
        ...
        "goToBallScore": {"condition": lambda mgr, state: mgr.getVisible("b"), "trueCond": "approachBallScore", "falseCond": "runTowardCenter"},
        "runTowardCenter": {"condition": lambda mgr, state: mgr.getVisible(mgr.getCenterFlag()), "trueCond": "approachCenterScore", "falseCond": "searchBallScore"},
        "approachCenterScore": {"condition": lambda mgr, state: abs(mgr.getAngle(mgr.getCenterFlag())) > 5, "trueCond": "turnToCenterScore", "falseCond": "dashToCenterScore"},
        "turnToCenterScore": {"exec": lambda mgr, state: state.__setitem__("command", ("turn", str(int(mgr.getAngle(mgr.getCenterFlag()))))), "next": "sendCommand"},
        "dashToCenterScore": {"exec": lambda mgr, state: state.__setitem__("command", ("dash", "100")), "next": "sendCommand"},
        "searchBallScore": {"exec": lambda mgr, state: state.__setitem__("command", ("turn", "60")), "next": "sendCommand"},
