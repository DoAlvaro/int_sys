def create_scorer_tree():
    tree = {
        ...
        "haveBallWhenDribble": {"condition": lambda mgr, state: mgr.getDistance("b") < 1.2, "trueCond": "closeEnoughToKick", "falseCond": "backToChaseBall"},
        ...
        "dribbleToGoal": {"condition": lambda mgr, state: mgr.getVisible(mgr.getGoalFlag()), "trueCond": "approachGoalDribble", "falseCond": "turnSearchGoal"},
        "turnSearchGoal": {"exec": lambda mgr, state: state.__setitem__("command", ("turn", "45")), "next": "sendCommand"},
        "approachGoalDribble": {"condition": lambda mgr, state: abs(mgr.getAngle(mgr.getGoalFlag())) > 5, "trueCond": "turnToGoalDribble", "falseCond": "dashWithBall"},
        "turnToGoalDribble": {"exec": lambda mgr, state: state.__setitem__("command", ("turn", str(int(mgr.getAngle(mgr.getGoalFlag()))))), "next": "sendCommand"},
        "dashWithBall": {"exec": lambda mgr, state: state.__setitem__("command", ("dash", "65")), "next": "sendCommand"},
