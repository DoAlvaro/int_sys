def create_scorer_tree():
    tree = {
        ...
        "searchBallScore": {"exec": lambda mgr, state: state.__setitem__("command", ("turn", "90")), "next": "sendCommand"},
        "approachBallScore": {"condition": lambda mgr, state: abs(mgr.getAngle("b")) > 3, "trueCond": "turnToBallScore", "falseCond": "dashToBallScore"},
